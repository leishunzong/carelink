...
/**
 * 用户创建匹配订单（选服务包、系统匹配护工）请求 DTO
 *
 * @author CareLink
 * @since 2026-02-11
 */
@Data
@ApiModel(description = "创建匹配订单参数")
public class MatchOrderCreateDTO {
    ...
    @ApiModelProperty("服务城市编码，用于匹配派单（不传则从用户表补全）")
    private String cityCode;

    @ApiModelProperty("匹配半径(km)，默认10")
    @Min(1)
    @Max(50)
    private Integer matchingRadius = 10;
    ...
    @ApiModelProperty("护工性别要求: 0不限 1男 2女")
    private Integer reqGender = 0;
    @ApiModelProperty("护工最低从业年限要求")
    private Integer reqWorkYears = 0;
    @ApiModelProperty("护工籍贯要求")
